...
#### 2.4.2. Create instance snapshots
...
#### 2.4.3. Control the state of an instance
...
### 2.6. Tạo và quản lý network

#### 2.6.1. Create a network
